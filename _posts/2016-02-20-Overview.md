...
![LSTM](http://www.cs.toronto.edu/~graves/title.jpeg)
Sinh chữ viết tay với [LSTM](http://www.cs.toronto.edu/~graves/handwriting.html). Demo bởi Alex Graves, thành viên sáng lập Google Deepmind, học trò của Juergen Schmidhuber.

<iframe width="420" height="315" src="https://www.youtube.com/watch?v=FwFduRA_L6Q" frameborder="0"> </iframe>
[Nhận dạng chữ viết với Convolutional Neural Networks (CNN)](https://www.youtube.com/watch?v=FwFduRA_L6Q). Demo bởi Yann Lecun, người phát minh ra CNN

<iframe width="420" height="315" src="https://www.youtube.com/watch?v=-R9bJGNHltQ" frameborder="0"> </iframe>
...
Vẽ tranh bằng [neural networks](https://www.youtube.com/watch?v=-R9bJGNHltQ). Những bức tranh này đã được rao bán trên ebay. Bài báo gốc: A Neural Algorithm of Artistic Style, Leon A. Gatys, Alexander S. Ecker, Matthias Bethge
